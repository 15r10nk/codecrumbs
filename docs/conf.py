#
# pytest-breadcrumes documentation build configuration file, created by
...
# ones.
extensions = ["sphinx.ext.ifconfig", "sphinx_rtd_theme", "sphinx.ext.autodoc"]
...
man_pages = [
    (
        ...
        "pytest-breadcrumes Documentation",
        [author],
        1,
    )
]
